...
class ChatLogViewModel: ObservableObject {
    ...
    func handleSend() {
        ...
        try? recipientMessageDocument.setData(from: msg) { error in
            ...
            print("Reccipient saved message as well")
        }
    }
...
struct ChatLogView: View {
    ...
    static let emptyScrillToString = "Empty"
...
//        NavigationView {
//            ChatLogView(chatUser: .init(data: ["uid": "WcBgd3pRsHSw3P2aBU8EOlp20Mo2", "email": "waterfall1@gmail.com"]))
//        }
        MainMessagesView()
    }
}
